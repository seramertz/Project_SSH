...
// // Start new terminal with backup process.
// func startBackupProcess() {
// 	exec.Command("gnome-terminal", "--", "go", "run", "main.go").Run()
// }

// // The primary process sends heartbeats to the backup process.
...
// // The backup process listens for heartbeats from the primary process.
// func backupProcess() {
// 	count := 1
